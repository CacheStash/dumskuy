...
import { Key, Moon, Sun, Sparkles, Cpu, Layers, Compass, FileText, Search } from 'lucide-react';
import { ApiProvider, ActiveAppTab } from '../types';
...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-slate-200/80 dark:border-studio-800 bg-white/90 dark:bg-studio-950/90 backdrop-blur-md transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500 dark:text-slate-400 hidden sm:block">
                Contextual dummy text & font name discovery for type designers
              </p>
            </div>
          </div>

          {/* Center Tabs (Desktop) */}
          <div className="hidden md:flex p-1 bg-slate-100 dark:bg-studio-900 rounded-xl border border-slate-200/60 dark:border-studio-800">
            <button
              onClick={() => onTabChange('specimen')}
            ...
            >
              ...
              <span>Dummy Copy Generator</span>
            </button>
            <button
              onClick={() => onTabChange('name-finder')}
              className={`px-4 py-2 text-xs font-bold rounded-lg transition-all flex items-center gap-2 ${
            ...
            >
              ...
              <span>Font Name Finder & Availability</span>
            </button>
          </div>
        ...
        <div className="flex md:hidden pb-3">
          <div className="flex w-full p-1 bg-slate-100 dark:bg-studio-900 rounded-xl border border-slate-200/60 dark:border-studio-800">
            <button
              onClick={() => onTabChange('specimen')}
